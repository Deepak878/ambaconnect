...
export default function JobsScreen({ jobs: propJobs, onOpenJob, onSaveJob, savedIds, filters, userLocation }) {
  ...
  }, [enriched, query, partTimeOnly, filterKind]);
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flexDirection: 'row', paddingHorizontal: 12, paddingBottom: 8, alignItems: 'center' }}>
        ...
        <TouchableOpacity onPress={() => setFilterKind('accommodation')} style={[shared.smallButton, { backgroundColor: filterKind==='accommodation'?Colors.primary:Colors.card, borderColor: filterKind==='accommodation'?Colors.primary:Colors.border }]}>
