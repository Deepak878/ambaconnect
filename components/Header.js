...
export default function Header({ title = 'Amba connect', onBack = null, onProfile = () => {}, user = null }) {
  ...
  return (
    <View style={{ paddingVertical: 12, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: Colors.card, borderBottomWidth: 1, borderColor: Colors.border }}>
      <View style={{ width: 40 }}>
        {onBack ? (
